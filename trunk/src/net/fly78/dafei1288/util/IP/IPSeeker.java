package net.fly78.dafei1288.util.IP;
import java.io.File;
...
public class IPSeeker {
	...
	private static final String IP_FILE = IPSeeker.class.getResource("QQWry.dat").toString();
		//new File(IPSeeker.class.getResource("QQWry.dat").toURI());
		//IPSeeker.class.getResource("QQWry.dat").toString().substring(6);
		//"C:/Documents and Settings/Administrator/桌面/keiko/src/net/fly78/dafei1288/util/IP/QQWry.dat";
	////
...
//		File f;
//		try {
//			f = new File(IPSeeker.class.getResource("QQWry.dat").toURI());
